...
export const MapPlaceholder: React.FC<MapPlaceholderProps> = ({
  ...
  return (
    ...
    >
      ...
      {currentPin && (
        <div className="z-20 self-center bg-surface border border-line rounded-xl p-3.5 shadow-xl max-w-sm w-full flex items-center justify-between gap-3 animate-fade-in">
