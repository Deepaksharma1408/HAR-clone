...
export const HouseSVGPlaceholder: React.FC<HouseSVGPlaceholderProps> = ({
  ...
  return (
    <div
      ...
      className={`w-full h-full flex items-center justify-center relative select-none overflow-hidden rounded-[2px] border border-line/50 transition-colors duration-300 ${className}`}
    >
