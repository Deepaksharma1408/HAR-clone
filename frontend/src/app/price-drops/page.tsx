  ...
  return (
    <div className="min-h-screen bg-bg text-ink font-inter">
      <main className="estateline-container py-12 space-y-10">
        <div className="bg-gradient-to-r from-purple-950 via-indigo-900 to-purple-900 text-white rounded-2xl p-8 md:p-12 shadow-lg space-y-4">
          <span className="inline-block px-3 py-1 bg-purple-500/30 text-purple-200 text-xs font-medium rounded-full border border-purple-400/30">
        ...
        {loading ? (
          <div className="py-12 text-center text-xs text-ink-soft">Loading price drops...</div>
        ) : (
                ...
                <Card className="h-full bg-surface p-0 rounded-2xl overflow-hidden border border-line flex flex-col justify-between hover:shadow-xl transition-all group">
                  <div>
                    <div className="h-48 w-full relative overflow-hidden bg-bg">
                      ...
                      <div className="absolute bottom-3 right-3 bg-red-950/90 text-red-200 text-[11px] px-2.5 py-0.5 rounded-full font-medium border border-red-500/30">
