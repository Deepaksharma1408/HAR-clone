    ...
    <div className="flex flex-col min-h-screen bg-bg">
      ...
      <main className="flex-1 estateline-container py-10 space-y-12">
              ...
              {myListings.map((item) => (
                <Card key={item.id} hoverable={false} className="bg-surface flex flex-col justify-between">
                  <div>
                    ...
                    <span className="text-xs font-mono text-ink-soft block mb-1">
                      {item.city}
                    </span>
                    ...
                    <span className="font-fraunces font-bold text-lg text-brass block">
                  ...
                  <div className="pt-4 border-t border-line mt-4 flex items-center justify-between gap-2">
                    ...
                    <Button
                      ...
                      className="text-danger hover:bg-danger/10 text-xs font-mono uppercase"
                    >
                      Delete
                    </Button>
                  </div>
        ...
        <div className="space-y-6 pt-6 border-t border-line">
          <div className="flex items-center justify-between border-b border-line/60 pb-2">
            <div>
              <EyebrowLabel>Inquiry Stream</EyebrowLabel>
              <h2 className="font-fraunces text-2xl font-semibold text-ink mt-1">
                Recent Leads ({myLeads.length})
              </h2>
            </div>
            <span className="text-xs font-mono text-ink-soft">
            ...
            <table className="w-full text-left text-xs border-collapse">
              ...
              <tbody className="divide-y divide-line/60">
                {myLeads.length > 0 ? (
                  myLeads.map((lead) => (
                    <tr key={lead.id} className="hover:bg-bg/50">
                      ...
                      <td className="py-3.5 px-4 text-ink">
                        <Link href={`/listings/${lead.listing_id}`} className="hover:text-brass font-medium underline">
                  ...
                  <tr>
                    <td colSpan={5} className="py-8 text-center text-xs font-mono text-ink-soft">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-ink/60 backdrop-blur-xs">
          <div className="bg-surface border border-line rounded-[2px] w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 shadow-2xl">
            <div className="flex items-center justify-between border-b border-line pb-4 mb-6">
              ...
              <button
                ...
                className="text-ink-soft hover:text-ink font-mono text-sm"
              >
                ✕
              </button>
            </div>
            ...
            {formError && (
              <div className="mb-4 p-3 bg-danger/10 border border-danger/20 text-danger text-xs font-mono uppercase rounded-[2px]">
                {formError}
              </div>
            )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-surface text-ink px-3 py-2 text-xs rounded-[2px] border border-line"
                  />
                </div>
              </div>
