    ...
    <div className="estateline-container py-12 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <Card hoverable={false} className="bg-surface">
          ...
          {error && (
            <div className="mb-4 p-2 bg-danger/10 text-danger text-[10px] font-mono uppercase rounded-[2px]">
              {error}
            </div>
          )}
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex justify-between text-xs font-mono text-ink-soft border-b border-line pb-2">
            <span>Configured Alerts ({alerts.length})</span>
            <span>Hourly Job Active</span>
          </div>
                ...
                return (
                  <Card key={item.id} hoverable={false} className="bg-surface flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="space-y-1">
                      ...
                      <span className="text-[10px] font-mono text-ink-soft/60 block">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg">
      ...
      <main className="flex-1">
        <Suspense fallback={<div className="py-20 text-center text-xs font-mono uppercase">Loading alert engine...</div>}>
          <AlertsContent />
        </Suspense>
      </main>
    </div>
