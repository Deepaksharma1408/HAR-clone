                ...
                <Link key={item.id} href={`/listings/${item.id}`}>
                  <Card className="h-full flex flex-col justify-between group relative">
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 z-10 p-1.5 rounded-full bg-surface/90 border border-line text-ink hover:text-danger transition-colors"
                    ...
                    <div>
                      <div className="h-48 w-full relative mb-3 overflow-hidden rounded-[2px] bg-bg">
