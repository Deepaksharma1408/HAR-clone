...
function ListingsContent() {
  ...
  return (
    <div className="estateline-container py-10">
      ...
      {tagInput === "open_house" && (
        <div className="mb-8 p-6 bg-gradient-to-r from-blue-900 via-indigo-900 to-blue-950 text-white rounded-2xl shadow-lg">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <span className="inline-block px-3 py-1 bg-blue-500/30 text-blue-200 text-xs font-medium rounded-full mb-2 border border-blue-400/30">
            ...
            <div className="flex flex-wrap gap-2">
              <button className="px-3.5 py-2 bg-white text-blue-950 font-medium text-xs rounded-full hover:bg-blue-50 transition-colors shadow-xs cursor-pointer">
                This Saturday (10am - 4pm)
              </button>
              <button className="px-3.5 py-2 bg-blue-800 text-white font-medium text-xs rounded-full hover:bg-blue-700 transition-colors cursor-pointer">
      ...
      {tagInput === "valuation" && (
        <div className="mb-8 p-6 bg-surface border border-brass/40 rounded-2xl shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            <div className="md:col-span-2">
              <span className="inline-block px-3 py-1 bg-amber-100 text-amber-900 text-xs font-medium rounded-full mb-2">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-bg border border-line rounded-lg text-xs font-inter focus:outline-none focus:border-brass focus:ring-2 focus:ring-brass/15"
                  defaultValue="1204 Oak Ridge Lane, Katy TX"
                />
                <button className="px-5 py-2.5 bg-brass text-white font-medium text-xs rounded-lg hover:bg-brass-deep transition-colors shadow-xs cursor-pointer">
                  Calculate Value
                </button>
              </div>
            </div>
            <div className="bg-bg border border-line p-4 rounded-xl text-center space-y-2">
              <span className="text-xs text-ink-soft font-medium">Estimated Market Value</span>
              <div className="font-fraunces text-3xl font-bold text-brass">$540,000</div>
              <div className="text-xs text-emerald-600 font-semibold">+6.8% Appreciated (1-Yr)</div>
              <div className="text-xs text-ink-soft">Est. Range: $515,000 – $565,000</div>
            </div>
          </div>
        </div>
      )}
      ...
      {(cityInput === "Katy" || cityInput === "Memorial" || cityInput === "The Heights") && (
        <div className="mb-8 p-6 bg-surface border border-line rounded-2xl shadow-sm">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 border-b border-line/60 pb-4">
            <div>
              <span className="inline-block px-3 py-1 bg-indigo-100 text-indigo-900 text-xs font-medium rounded-full mb-1">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="bg-bg p-3.5 rounded-xl text-center border border-line">
              <div className="text-xs font-medium text-ink-soft">Safety Rating</div>
              <div className="font-semibold text-lg text-emerald-600">96 / 100</div>
              <div className="text-xs text-ink-soft">Top Tier Safety</div>
            </div>
            <div className="bg-bg p-3.5 rounded-xl text-center border border-line">
              <div className="text-xs font-medium text-ink-soft">School Score</div>
              <div className="font-semibold text-lg text-blue-600">10 / 10</div>
              <div className="text-xs text-ink-soft">GreatSchools Certified</div>
            </div>
            <div className="bg-bg p-3.5 rounded-xl text-center border border-line">
              <div className="text-xs font-medium text-ink-soft">Walk Score</div>
              <div className="font-semibold text-lg text-amber-600">88 / 100</div>
              <div className="text-xs text-ink-soft">Very Walkable</div>
            </div>
            <div className="bg-bg p-3.5 rounded-xl text-center border border-line">
              <div className="text-xs font-medium text-ink-soft">Avg Commute</div>
              <div className="font-semibold text-lg text-ink">22 Mins</div>
              <div className="text-xs text-ink-soft">To Downtown HQ</div>
            </div>
          </div>
        </div>
      )}
      ...
      {tagInput === "new_construction" && (
        <div className="mb-8 p-6 bg-gradient-to-r from-emerald-950 via-teal-900 to-emerald-900 text-white rounded-2xl shadow-lg">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <span className="inline-block px-3 py-1 bg-emerald-500/30 text-emerald-200 text-xs font-medium rounded-full mb-2 border border-emerald-400/30">
            ...
            <div className="flex items-center gap-2">
              <span className="px-3.5 py-1.5 bg-emerald-800/80 text-white font-medium text-xs rounded-full">
                Toll Brothers
              </span>
              <span className="px-3.5 py-1.5 bg-emerald-800/80 text-white font-medium text-xs rounded-full">
                Perry Homes
              </span>
              <span className="px-3.5 py-1.5 bg-white text-emerald-950 font-medium text-xs rounded-full">
                Move-In Ready
              </span>
            </div>
          </div>
      ...
      {tagInput === "price_reduced" && (
        <div className="mb-8 p-6 bg-gradient-to-r from-purple-950 via-indigo-900 to-purple-900 text-white rounded-2xl shadow-lg">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <span className="inline-block px-3 py-1 bg-purple-500/30 text-purple-200 text-xs font-medium rounded-full mb-2 border border-purple-400/30">
            ...
            <button className="px-5 py-2.5 bg-purple-500 hover:bg-purple-400 text-white font-medium text-xs rounded-full transition-colors shadow-xs cursor-pointer">
      ...
      {tagInput === "foreclosure" && (
        <div className="mb-8 p-6 bg-gradient-to-r from-slate-900 via-gray-900 to-slate-950 text-white rounded-2xl shadow-lg border border-slate-700">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <span className="inline-block px-3 py-1 bg-slate-700 text-slate-200 text-xs font-medium rounded-full mb-2">
            ...
            <button className="px-5 py-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-medium text-xs rounded-full transition-colors shadow-xs cursor-pointer">
      ...
      {tagInput === "global" && (
        <div className="mb-8 p-6 bg-gradient-to-r from-teal-950 via-cyan-900 to-teal-900 text-white rounded-2xl shadow-lg">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <span className="inline-block px-3 py-1 bg-teal-500/30 text-teal-200 text-xs font-medium rounded-full mb-2 border border-teal-400/30">
            ...
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 bg-teal-800 text-xs font-medium rounded-md">USD ($)</span>
              <span className="px-3 py-1 bg-teal-800 text-xs font-medium rounded-md">EUR (€)</span>
              <span className="px-3 py-1 bg-teal-800 text-xs font-medium rounded-md">GBP (£)</span>
            </div>
          </div>
        </div>
      )}
      ...
      {selectedType === "Penthouse" && (
        <div className="mb-8 p-6 bg-gradient-to-r from-amber-950 via-stone-900 to-amber-900 text-white rounded-2xl shadow-lg">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <span className="inline-block px-3 py-1 bg-amber-500/30 text-amber-200 text-xs font-medium rounded-full mb-2 border border-amber-400/30">
            ...
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 bg-amber-900/60 text-amber-200 text-xs font-medium rounded-full border border-amber-500/30">
          ...
          <div className="flex border border-line rounded-lg overflow-hidden">
            <button
              ...
              className={`px-3.5 py-2 text-xs font-medium transition-colors cursor-pointer ${
                viewMode === "grid" ? "bg-brass text-white shadow-xs" : "bg-surface text-ink hover:bg-bg"
              }`}
            >
              Grid
            </button>
            <button
              ...
              className={`px-3.5 py-2 text-xs font-medium transition-colors cursor-pointer ${
                viewMode === "list" ? "bg-brass text-white shadow-xs" : "bg-surface text-ink hover:bg-bg"
              }`}
            >
              List
            </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-6">
          <Card hoverable={false} className="space-y-5 bg-surface rounded-2xl">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {totalCount > 9 && (
            <div className="flex items-center justify-center gap-3 pt-6 border-t border-line">
              ...
              <span className="text-xs font-medium text-ink-soft px-2">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg">
      <main className="flex-1">
        <Suspense fallback={<div className="py-20 text-center text-xs text-ink-soft">Loading search engine...</div>}>
          <ListingsContent />
        </Suspense>
      </main>
    </div>
