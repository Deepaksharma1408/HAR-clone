                    ...
                    <Card className="h-full flex flex-col justify-between group">
                      <div>
                        <div className="flex items-center justify-between mb-4">
                          <div className="w-12 h-12 rounded-full bg-sage-soft text-sage flex items-center justify-center font-fraunces font-bold text-xl group-hover:bg-brass group-hover:text-white transition-colors">
                      ...
                      <div className="pt-4 border-t border-line mt-6 flex items-center justify-between text-xs font-medium text-brass">
        ...
        {!loading && allAgents.length > 0 && (
          <section>
            <div className="mb-6 flex items-end justify-between border-b border-line pb-3">
              ...
              <span className="text-xs font-medium text-ink-soft">{allAgents.length} advisors</span>
            </div>
            ...
            <div className="divide-y divide-line border border-line rounded-xl overflow-hidden bg-surface">
              {allAgents.map((agent, idx) => (
                ...
                >
                  ...
                  {/* Rank */}
                  <span className="text-xs text-ink-soft/50 flex-shrink-0 hidden sm:block font-medium">
