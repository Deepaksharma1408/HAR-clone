      ...
      <main className="flex-1 estateline-container py-12 space-y-12">
        ...
        <Card hoverable={false} className="bg-surface p-8">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            <div className="w-20 h-20 rounded-2xl bg-brass text-white font-fraunces font-bold text-3xl flex items-center justify-center shadow-sm">
            ...
            <div className="space-y-1 flex-1">
              ...
              <span className="block text-xs font-medium text-brass">
                {agent.role_title}
              </span>
        ...
        <div className="space-y-6">
          ...
          {agent.listings.length === 0 ? (
            <Card hoverable={false} className="py-12 text-center text-xs text-ink-soft">
