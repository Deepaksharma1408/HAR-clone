  ...
  return (
    <div className="min-h-screen bg-bg text-ink font-inter">
      ...
      <main className="estateline-container py-12 space-y-10">
        <div className="bg-gradient-to-r from-emerald-950 via-teal-900 to-emerald-900 text-white rounded-[20px] p-8 md:p-12 shadow-lg space-y-4">
          <span className="inline-block px-3 py-1 bg-emerald-500/30 text-emerald-200 text-xs font-mono uppercase rounded-full border border-emerald-400/30">
            🌟 Real-Time MLS Feed
          </span>
        ...
        {loading ? (
          <div className="py-12 text-center text-xs font-mono uppercase text-ink-soft">Loading just listed feed...</div>
        ) : (
                ...
                <Card className="h-full bg-surface p-0 rounded-[16px] overflow-hidden border border-line flex flex-col justify-between hover:shadow-xl transition-all group">
                  <div>
                    <div className="h-48 w-full relative overflow-hidden bg-bg">
                      ...
                      <div className="absolute bottom-3 right-3 bg-black/80 text-emerald-300 text-[10px] font-mono px-2 py-0.5 rounded">
                        Listed {idx + 1}h ago
                      </div>
                    </div>
